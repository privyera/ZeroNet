...
class TestConfig:
    def testParse(self):
        # Defaults
        config_test = Config.Config("zeronet".split(" "))
        ...
        config_test = Config.Config("zeronet --debug --debug_socket --ui_password hello".split(" "))
        config_test.parse(silent=True, parse_config=False)
        ...
        # More complex test
        args = "zeronet --unknown_arg --debug --debug_socket --ui_restrict 127.0.0.1 1.2.3.4 "
